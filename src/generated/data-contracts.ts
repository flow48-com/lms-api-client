...
export enum IncorporationCountryEnum {
  EG = 'EG',
  JO = 'JO',
  SA = 'SA',
  AE = 'AE',
...
/** @example "Direct" */
export enum CompanyResponseCompanySourceTypeEnum {
  Partner = 'Partner',
  Direct = 'Direct',
 ...
 * @example "Pending"
 */
export enum LoanResponseLoanStatusEnum {
  Pending = 'Pending',
  Approved = 'Approved',
  Active = 'Active',
  Late = 'Late',
 ...
 * @example "NEW"
 */
export enum DisbursementRequestResponseStatusEnum {
  NEW = 'NEW',
  APPROVED = 'APPROVED',
  PAID = 'PAID',
  FAILED = 'FAILED',
 ...
 * @example "Normal"
 */
export enum DisbursementRequestResponsePriorityEnum {
  Normal = 'Normal',
  Urgent = 'Urgent',
}

export enum RevioPayPurchaseRequestClientDetailsEnum {
  Email = 'email',
  Phone = 'phone',
  FullName = 'full_name',
 ...
 * @example "RBF"
 */
export enum NewLoanLoanTypeEnum {
  RBF = 'RBF',
  IBF = 'IBF',
  IBF2 = 'IBF2',
}
 ...
 * @example "FIXED"
 */
export enum NewLoanPenaltyTypeEnum {
  FIXED = 'FIXED',
  VARIABLE = 'VARIABLE',
}
 ...
 * @example "INTEREST_UPFRONT"
 */
export enum NewLoanInterestAllocationTypeEnum {
  INTEREST_UPFRONT = 'INTEREST_UPFRONT',
  SPLIT_EQUALLY = 'SPLIT_EQUALLY',
}

/** @example "monthly_fixed" */
export enum NewLoanRepaymentTypeEnum {
...
/** @example "MONEY_RECEIVED" */
export enum NewRepaymentTypeEnum {
  MONEY_RECEIVED = 'MONEY_RECEIVED',
  EXPENSE = 'EXPENSE',
}

export enum NewRepaymentExpenseCategoryEnum {
...
export enum CancelOperationRequestReasonEnum {
  ERROR = 'ERROR',
  DISPUTE = 'DISPUTE',
  OTHER = 'OTHER',
}
...
export enum GetCompaniesParams1IncludeEnum {
  IncorporationDate = 'incorporationDate',
  CompanyType = 'companyType',
  Industry = 'industry',
  IsPartner = 'isPartner',
...
/** Field by which the records will be sorted */
export enum GetCompanyActionLogParams1SortByEnum {
  CreatedAt = 'createdAt',
}
...
/** Company field by which the records will be sorted */
export enum GetCompanyLoansParams1SortByEnum {
  CompanyIdentifier = 'companyIdentifier',
  LoanOfficerUserId = 'loanOfficerUserId',
  LoanType = 'loanType',
  GracePeriodDays = 'gracePeriodDays',
...
export enum GetCompanyLoansParams1IncludeEnum {
  SalesforceOpportunityId = 'salesforceOpportunityId',
  LoanOfficerUserId = 'loanOfficerUserId',
  GracePeriodDays = 'gracePeriodDays',
  PenaltyPercent = 'penaltyPercent',
...
export enum GetScheduleItemsParams1IncludeEnum {
  EntityId = 'entityId',
  LoanId = 'loanId',
  PrincipalPaid = 'principalPaid',
  InterestPaid = 'interestPaid',
...
export enum GetScheduleItemsParams1LoanIncludeEnum {
  AnnualRate = 'annualRate',
  CancelNote = 'cancelNote',
  CompanyIdentifier = 'companyIdentifier',
  Company = 'company',
...
/** Company field by which the records will be sorted */
export enum GetLoansParams1SortByEnum {
  CompanyIdentifier = 'companyIdentifier',
  LoanOfficerUserId = 'loanOfficerUserId',
  LoanType = 'loanType',
  GracePeriodDays = 'gracePeriodDays',
...
/** Field by which the records will be sorted */
export enum GetLoanActionLogParams1SortByEnum {
  CreatedAt = 'createdAt',
}
 ...
 * @example "IBF"
 */
export enum CalculateLoanInterestLoanTypeEnum {
  RBF = 'RBF',
  IBF = 'IBF',
  IBF2 = 'IBF2',
}
...
export enum IncludeTransactionTypeEnum {
...
/** Field by which the records will be sorted */
export enum GetTransactionsParams1SortByEnum {
  CreatedAt = 'createdAt',
}

export enum GetTransactionsParams1IncludeTransactionTypeEnum {
  DISBURSEMENT = 'DISBURSEMENT',
  MONEY_RECEIVED = 'MONEY_RECEIVED',
  MONEY_ALLOCATED = 'MONEY_ALLOCATED',
  LOSSES = 'LOSSES',
...
/** Field by which the records will be sorted */
export enum GetLoanDisbursementRequestsParams1SortByEnum {
  RequestedOn = 'requestedOn',
}
