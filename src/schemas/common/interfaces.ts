...
import {
  ...
  CurrencyEnumSchema,
  LoanInterestAllocationTypeEnumSchema,
  LoanStatusEnumSchema,
  LoanTypeEnumSchema,
  LoanTypeRepaymentEnumSchema,
  PenaltyTypeEnumSchema,
  PurchaseStatusEnumSchema,
...
export type TLoanInterestAllocationTypeEnumSchema = z.infer<
  typeof LoanInterestAllocationTypeEnumSchema
>;
