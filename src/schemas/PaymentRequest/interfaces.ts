import { z } from 'zod';
import {
  CreatePaymentLinkRequestsSchemaResponse,
  PaymentLinkRequestSchema,
  PaymentLinkRequestsSchemaResponse,
  PaymentRequestSchema,
  PaymentRequestsSchemaResponse,
} from 'schemas/PaymentRequest/PaymentRequest.schema';
...
export type TCreatePaymentLinkRequestsSchemaResponse = z.infer<
  typeof CreatePaymentLinkRequestsSchemaResponse
>;
