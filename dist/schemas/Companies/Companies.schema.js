...
import { CompaniesLinksSchemaResponse, CompanyLinksSchema, } from 'schemas/Companies/CompanyLinks.schema';
...
export const BaseCompanySchema = _baseCompanySchema.extend({
    partnerCompany: z
        .lazy(() => _baseCompanySchema.omit({
        _links: true,
    }))
        .nullish(),
});
export const CompaniesSchemaResponse = BaseSchema.merge(z.object({
